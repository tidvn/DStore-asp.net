...
namespace DStore.Areas.Dashboard.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<ActionResult> PutData(Product product, List<IFormFile> files)
        {
            ...
            foreach (var file in files)
            {
                ...
                p.Name = "Demo Product";
                p.Description = "Demo";
                p.Images = new List<String>(lst);
                p.Price = rnd.Next(1000000, 50000000);
                await _productsService.CreateAsync(p);
            }
